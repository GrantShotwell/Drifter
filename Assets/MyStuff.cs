...
namespace MyStuff {
    ...
    public class Geometry {
        ...
        /// </summary>
        /// <param name="degr">The input angle in degrees.</param>
        /// <returns>Returns 'degr * Mathf.Deg2Rad'.</returns>
        public static float ConvertToRadians(float degr) { return degr * Mathf.Deg2Rad; }

        /// <summary>
        /// Converts radians into degrees.
        /// </summary>
        /// <param name="radi">The input angle in radians.</param>
        /// <returns>Returns 'radi * Mathf.Rad2Deg'.</returns>
        public static float ConvertToDegrees(float radi) { return radi * Mathf.Rad2Deg; }
        ...
        public static Vector2 Vector2FromAngle(float angle, float magnitude, AngleType units = AngleType.Degrees) {
    ...
    namespace GeometryObjects {
        ...
        #region Classes
        /// <summary>
        /// Stores data and methods for an angle. Often used by the Geometry class.
        /// </summary>
        public class Angle {
            public float value;
            ...
            public Angle(float value, AngleType type = AngleType.Degrees) {
                this.value = value;
                this.type = type;
            }
    ...
    public class CameraLimit {
        ...
        public bool limitsSize => size != null;
    ...
    public static class Extensions {
        ...
        public static Vector2 RotateTo(this Vector2 v1, Vector2 v2, float degrees, AngleType units = AngleType.Degrees) {
