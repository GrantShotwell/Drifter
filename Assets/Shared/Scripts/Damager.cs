...
public class Damager : MonoBehaviour {
    ...
    public ColliderSettings colliderSettings = new ColliderSettings(); //only with useCollision
    ...
    public TriggerSettings triggerSettings = new TriggerSettings(); //only with useTrigger
